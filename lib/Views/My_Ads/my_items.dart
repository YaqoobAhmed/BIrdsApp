...
class MyItems extends StatefulWidget {
  ...
  MyItems({required this.currentUserUid});

  @override
  State<MyItems> createState() => _MyAdsState();
}

class _MyAdsState extends State<MyItems> {
    ...
    while (true) {
      try {
        yield* FirebaseFirestore.instance
            .collection("FoodAdds")
            .where("uid", isEqualTo: widget.currentUserUid)
            .snapshots();
        return;
      } catch (e) {
