...
class MyAds extends StatelessWidget {
  final String currentUserUid; // Add this variable

  MyAds(
      {required this.currentUserUid}); // Constructor to initialize the variable
  ...
  Stream<QuerySnapshot> fetchData() async* {
    ...
    while (true) {
      try {
        // Add the query to filter documents based on UID
